...
@Component({
  selector: 'app-third-parties-customers-create-dialog',
  templateUrl: './third-parties-customers-create-dialog.component.html',
  styles: []
})
export class ThirdPartiesCustomersCreateDialogComponent implements OnInit {
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<ThirdPartiesCustomersCreateDialogComponent>,
