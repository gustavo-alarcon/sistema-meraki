...
@Component({
  selector: 'app-check-stock-create-wholesale-dialog',
  templateUrl: './check-stock-create-wholesale-dialog.component.html',
  styles: []
})
export class CheckStockCreateWholesaleDialogComponent implements OnInit {
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<CheckStockCreateWholesaleDialogComponent>,
