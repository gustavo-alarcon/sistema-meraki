...
@Component({
  selector: 'app-stores-create-customer-dialog',
  templateUrl: './stores-create-customer-dialog.component.html',
  styles: []
})
export class StoresCreateCustomerDialogComponent implements OnInit {
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<StoresCreateCustomerDialogComponent>,
