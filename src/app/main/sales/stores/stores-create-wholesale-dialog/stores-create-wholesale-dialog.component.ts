...
@Component({
  selector: 'app-stores-create-wholesale-dialog',
  templateUrl: './stores-create-wholesale-dialog.component.html',
  styles: []
})
export class StoresCreateWholesaleDialogComponent implements OnInit {
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<StoresCreateWholesaleDialogComponent>,
